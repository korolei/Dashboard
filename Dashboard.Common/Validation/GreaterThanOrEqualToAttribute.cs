...
namespace Dashboard.Common.Validation
{
    ...
    public sealed class GreaterThanOrEqualToAttribute : ValidationAttribute
    {
        ...
        private const string _defaultErrorMessage = "{0} must be greater than or equal to {1}.";
        ...
        public GreaterThanOrEqualToAttribute(string basePropertyName) : base(_defaultErrorMessage)
        {
